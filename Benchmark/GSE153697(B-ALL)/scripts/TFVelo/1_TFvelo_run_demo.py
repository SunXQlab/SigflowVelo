...
def preprocess(args):
    ...
    if args.dataset_name == 'pancreas':
        ...
        adata.obs['clusters'] = adata.obs['celltype'].copy()
    elif args.dataset_name == 'Maglignant_cells':
        adata = ad.read_h5ad("../../data/scPDAC_with_su_normalized.h5ad")
    ...
    if "spliced" in adata.layers:
        ...
        adata.layers["total"] = spliced + unspliced
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        class Args:
            ...
            basis = 'umap'
        args = Args()
    args.result_path = "../../results/TFVelo/adata/"
    print('********************************************************************************************************')
    print('********************************************************************************************************')  
    print(args)
    preprocess(args)  
